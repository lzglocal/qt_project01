...
Icon_helper *Icon_helper::iconFontAliBaBa = 0;
Icon_helper *Icon_helper::iconFontAwesome = 0;
Icon_helper *Icon_helper::iconFontAwesome6 = 0;
Icon_helper *Icon_helper::iconFontWeather = 0;
int Icon_helper::iconFontIndex = -1;

void Icon_helper::initFont()
{
    static bool isInit = false;
    if (!isInit) {
        isInit = true;
        if (iconFontAliBaBa == 0) {
            iconFontAliBaBa = new Icon_helper(":/font/iconfont.ttf", "iconfont");
        }
        if (iconFontAwesome == 0) {
            iconFontAwesome = new Icon_helper(":/font/fontawesome-webfont.ttf", "FontAwesome");
        }
        if (iconFontAwesome6 == 0) {
            iconFontAwesome6 = new Icon_helper(":/font/fa-regular-400.ttf", "Font Awesome 6 Pro Regular");
        }
        if (iconFontWeather == 0) {
            iconFontWeather = new Icon_helper(":/font/pe-icon-set-weather.ttf", "pe-icon-set-weather");
        }
    }
}

void Icon_helper::setIconFontIndex(int index)
{
    iconFontIndex = index;
}

QFont Icon_helper::getIconFontAliBaBa()
{
    initFont();
    return iconFontAliBaBa->getIconFont();
}

QFont Icon_helper::getIconFontAwesome()
{
    initFont();
    return iconFontAwesome->getIconFont();
}

QFont Icon_helper::getIconFontAwesome6()
{
    initFont();
    return iconFontAwesome6->getIconFont();
}

QFont Icon_helper::getIconFontWeather()
{
    initFont();
    return iconFontWeather->getIconFont();
}

Icon_helper *Icon_helper::getIcon_helper(int icon)
{
    initFont();
    ...
    Icon_helper *Icon_helper = iconFontAwesome;
    if (iconFontIndex < 0) {
        if ((icon > 0xe501 && icon < 0xe793) || (icon > 0xe8d5 && icon < 0xea5d)) {
            Icon_helper = iconFontAliBaBa;
        }
    } else if (iconFontIndex == 0) {
        Icon_helper = iconFontAliBaBa;
    } else if (iconFontIndex == 1) {
        Icon_helper = iconFontAwesome;
    } else if (iconFontIndex == 2) {
        Icon_helper = iconFontAwesome6;
    } else if (iconFontIndex == 3) {
        Icon_helper = iconFontWeather;
    }

    return Icon_helper;
}

void Icon_helper::setIcon(QLabel *lab, int icon, quint32 size)
{
    getIcon_helper(icon)->setIcon1(lab, icon, size);
}

void Icon_helper::setIcon(QAbstractButton *btn, int icon, quint32 size)
{
    getIcon_helper(icon)->setIcon1(btn, icon, size);
}

void Icon_helper::setPixmap(QAbstractButton *btn, const QColor &color, int icon, quint32 size,
                           quint32 width, quint32 height, int flags)
{
    getIcon_helper(icon)->setPixmap1(btn, color, icon, size, width, height, flags);
}

QPixmap Icon_helper::getPixmap(const QColor &color, int icon, quint32 size,
                              quint32 width, quint32 height, int flags)
{
    return getIcon_helper(icon)->getPixmap1(color, icon, size, width, height, flags);
}

void Icon_helper::setStyle(QWidget *widget, QList<QPushButton *> btns,
                          QList<int> icons, const Icon_helper::StyleColor &styleColor)
{
    int icon = icons.first();
    getIcon_helper(icon)->setStyle1(widget, btns, icons, styleColor);
}

void Icon_helper::setStyle(QWidget *widget, QList<QToolButton *> btns,
                          QList<int> icons, const Icon_helper::StyleColor &styleColor)
{
    int icon = icons.first();
    getIcon_helper(icon)->setStyle1(widget, btns, icons, styleColor);
...
void Icon_helper::setStyle(QWidget *widget, QList<QAbstractButton *> btns,
                          QList<int> icons, const Icon_helper::StyleColor &styleColor)
{
    int icon = icons.first();
    getIcon_helper(icon)->setStyle1(widget, btns, icons, styleColor);
...
Icon_helper::Icon_helper(const QString &fontFile, const QString &fontName, QObject *parent) : QObject(parent)
{
    //判断图形字体是否存在,不存在则加入
...
bool Icon_helper::eventFilter(QObject *watched, QEvent *event)
{
    //根据不同的
...
void Icon_helper::toggled(bool checked)
{
    //选中和不选中设置不同的图标
...
QFont Icon_helper::getIconFont()
{
    return this->iconFont;
}

void Icon_helper::setIcon1(QLabel *lab, int icon, quint32 size)
{
...
void Icon_helper::setIcon1(QAbstractButton *btn, int icon, quint32 size)
{
    iconFont.setPixelSize(size);
...
void Icon_helper::setPixmap1(QAbstractButton *btn, const QColor &color, int icon, quint32 size,
                            quint32 width, quint32 height, int flags)
{
    btn->setIcon(getPixmap1(color, icon, size, width, height, flags));
}

QPixmap Icon_helper::getPixmap1(const QColor &color, int icon, quint32 size,
                               quint32 width, quint32 height, int flags)
{
    //主动绘制图形字体到图片
...
void Icon_helper::setStyle1(QWidget *widget, QList<QPushButton *> btns, QList<int> icons, const Icon_helper::StyleColor &styleColor)
{
...
void Icon_helper::setStyle1(QWidget *widget, QList<QToolButton *> btns, QList<int> icons, const Icon_helper::StyleColor &styleColor)
{
    QList<QAbstractButton *> list;
...
void Icon_helper::setStyle1(QWidget *widget, QList<QAbstractButton *> btns, QList<int> icons, const Icon_helper::StyleColor &styleColor)
{

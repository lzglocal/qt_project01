...
#ifdef quc
class Q_DECL_EXPORT Icon_helper : public QObject
#else

class Icon_helper : public QObject
#endif
...
private:
    //阿里巴巴图形字体类
    static Icon_helper *iconFontAliBaBa;
    //FontAwesome图形字体类
    static Icon_helper *iconFontAwesome;
    //FontAwesome6图形字体类
    static Icon_helper *iconFontAwesome6;
    //天气图形字体类
    static Icon_helper *iconFontWeather;
    //图形字体索引
...
public:
    ...
    //根据值获取图形字体类
    static Icon_helper *getIcon_helper(int icon);
    ...
    //默认构造函数,传入字体文件+字体名称
    explicit Icon_helper(const QString &fontFile, const QString &fontName, QObject *parent = 0);
